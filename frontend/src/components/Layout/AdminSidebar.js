...
function AdminSidebar({ onLogout, theme, toggleTheme }) {
  const menuItems = [
    {
      name: 'Dashboard',
  ...
  return (
    <aside className="w-20 lg:w-72 glass m-4 mr-0 rounded-3xl flex flex-col items-center lg:items-stretch overflow-hidden border-r-0 z-50">
      <div className="p-6 lg:p-8 flex items-center justify-center lg:justify-start gap-3">
        ...
        <div className="hidden lg:block">
            <span className="text-xl font-black bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">Admin Panel</span>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Control Center</p>
        </div>
      </div>
